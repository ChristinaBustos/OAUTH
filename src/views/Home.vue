<template>
    <div class="home">
      ...
      <div v-if="!$auth.loading">
        ...
        <b-button variant="outline-primary" v-if="!$auth.isAuthenticated" @click="login">Log in</b-button>
        <!-- muestra el botón de Log out si está autentificado -->
        <b-button variant="outline-primary" v-if="$auth.isAuthenticated" @click="logout">Log out</b-button>
      </div>
